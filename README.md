...
- (개인)[A사 부진 재고 분석](재고 회전율 기반 부진 재고 분류 로직 개발)
  - 3개월간의 판매·재고 데이터를 활용해 재고 회전율·소진율 등 핵심 지표를 산출하고, 이를 기반으로 부진·관심·정상 재고로 자동 분류하는 로직을 개발함.
  - 분석 결과, 전체 재고의 약 25%가 부진 재고로 분류되었으며, 부진은 AP·KIDS·WOMENS 등 특정 제품군에 집중됨.
